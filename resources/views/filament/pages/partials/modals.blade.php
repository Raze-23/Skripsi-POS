    ...
    @if ($showReceiptModal)
        ...
        <div class="receipt-panel">
            <div class="receipt-card"
                style="background:#fff; border-radius:16px; padding:24px; max-width:360px; width:100%; text-align:center; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1);">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px;">
                    ...
                    <button type="button" onclick="jalankanCetakNota({{ $lastTransactionId }})"
